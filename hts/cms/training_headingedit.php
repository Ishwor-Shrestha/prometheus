...
include("class/trainingpage.class.php");
	if(!isset($_SESSION['Login_Name'])){
		...
		if(isset($_POST['update'])){
			$Trainingpage -> editTrainingHeading();
			}
?>
...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Edit Training Heading</a></div>
<div class="header2">
    <?php
 ...
 <div class="form2">
   ...
   $sql2="select * from trainingheading where headingID='$a';";
