...
include("class/servicepage.class.php");
	...
	if(isset($_POST['submit'])){
		$Servicepage -> addServiceSubHeading();
		}
...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Service</a></div>
<div class="header2">
    <?php
...
<div class="form1">
 <br /><br />
 <?php
 	$query = "SELECT * FROM serviceheading;";
 ...
 <table>
	...
	<tr>
	<td>Sub Image </td>
	<td>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="newimg" class="upload"/></td>
	</tr>	
    <tr>
