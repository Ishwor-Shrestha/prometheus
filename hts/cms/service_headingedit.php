...
if(isset($_POST['update'])){
	$Servicepage -> editServiceHeading();
	}
?>
...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Edit Services</div>
<div class="header2">
    <?php
 ...
 <div class="form2">
   ...
   $sql2="select * from serviceheading where headingID='$a';";
