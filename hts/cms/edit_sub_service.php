...
include("class/servicepage.class.php");
	...
	if(!isset($_SESSION['Login_Name'])){
		...
		$Servicepage -> deleteSubService();
		}

		if(isset($_POST['edit'])){
		$Servicepage -> editSubService();
		}
?>
...
<title>Edit/Delete Sub Services</title>
...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Edit/Delete Sub Services</a></div>
<div class="header2">
   <?php
 ...
 ?>
  ...
  <script>
					...
					xmlhttp.open("GET","get_sub_service_detail.php?q2="+str,true);
					xmlhttp.send();
					}
			</script> 
 ...
 <?php
 	$query = "SELECT distinct subName FROM servicesub where headingID='$a';";
 ...
 // For each item in the results...
      ...
      // No results found in the database
       else { echo "<a href='service_sub_edit-delete.php'>No results found. Reload</a>"; }
    }
...
<?
header('location:edit_sub_service.phpsup='.$a);
?>
