<?php
    include("connect.php");
    include("class/aboutpage.class.php");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="header"><a href="#" style="text-decoration:none; color:#333;">Add New Article for About Page</a></div>
            <div class="header2">
            <?php
