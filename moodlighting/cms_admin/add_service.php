...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Add New Service</a></div>
<div class="header2">
    <?php
...
<input type="submit" value="Add Service" name="submit" style="width:300px; height:40px; font-size:16px; margin:16px 16px 16px 0px;" />
</form>
</div>
</div>
</body>
