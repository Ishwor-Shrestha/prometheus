...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Add Customer</a></div>
<div class="header2">
<?php
...
<form method="post" action=""  enctype="multipart/form-data">
    <div class="form1">
        <table>
          ...
          <tr> 
		<td> Customer Link: </td>
                <td> <input type="text" name="clink" autofocus required/></td>
		</tr>
