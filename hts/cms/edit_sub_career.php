...
include("class/careerpage.class.php");
	...
	$Careerpage -> deleteSubCareer();
	}

	if(isset($_POST['edit'])){
	$Careerpage -> editSubCareer();
	}
?>
...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Edit/Delete Sub Career</a></div>
<div class="header2">
    <?php
 ...
 ?>
  ...
  <script>
					...
					xmlhttp.open("GET","get_sub_career_detail.php?q2="+str,true);
					xmlhttp.send();
					}
			</script> 
 ...
 <?php
 	$query = "SELECT distinct subName FROM careersub where headingID='$a';";
 ...
 // For each item in the results...
      ...
      // No results found in the database
       else { echo "<a href='career_sub_edit-delete.php'>No results found. Reload</a>"; }
    }
 ...
 ?> 
  <br>
	...
	<?php
	$query = "SELECT * FROM careersub where headingID='$a';";
...
<?
header('location:edit_sub_career.phpsup='.$a);
?>
