...
<div class="header"><a href="#" style="text-decoration:none; color:#333;">Delete Slider Image</a></div>
<div class="header2">
    <?php
...
<?php
     ...
     <tr>
     <td >
            <div style="margin:-20;"><img src="<?php echo "../../hts/".$imgPath[$i]?>" height="200px" width ="200px" ></div>
            <div style="width:290px;"><?php echo $imgName[$i]?></div>
          <a style="text-decoration:none;" href="image_delete.php?id=<?php echo $imageID[$i]?>">Delete</a> 
     ...
     <td >
            ...
            <a style="text-decoration:none;" href="image_delete.php?id=<?php echo $imageID[$i+1]?>">Delete</a> 
     ...
     <td >
            ...
            <a style="text-decoration:none;" href="image_delete.php?id=<?php echo $imageID[$i+2]?>">Delete</a> 
