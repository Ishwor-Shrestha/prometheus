...
<?php
     ...
     <tr>
     <td >
            <div style="margin-left:-60;"><img src="<?php echo "../../hts/".$imgPath[$i]?>" height="170px" width ="170px" ></div>
     ...
     ?>
     <td >
            <div style="margin-left:-60;"><img src="<?php echo "../../hts/".$imgPath[$i+1]?>" height="170px" width ="170px"></div>
     ...
     ?>
     <td >
            <div style="margin-left:-60;"><img src="<?php echo "../../hts/".$imgPath[$i+2]?>" height="170px" width ="170px"></div>
